...
export default props=>{
    return (
        <div>
            <div>{props.error==="userLengthError" ? "Please make sure your username is between 1 and 50 characters" : null}</div>
            <div>{props.error==="passwordLengthError" ? "Please make sure your password is between 8 and 25 characters" : null}</div>
